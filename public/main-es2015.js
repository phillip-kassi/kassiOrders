...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<mat-sidenav-container class=\"sidenav-container\">\n  <mat-sidenav\n              #drawer\n              class=\"sidenav\"\n              fixedInViewport=\"true\"\n              [attr.role]=\"(isHandset$ | async) ? 'dialog' : 'navigation'\"\n              [mode]=\"(isHandset$ | async) ? 'over' : 'side'\"\n              [opened]=\"(isHandset$ | async) === false\">\n    <mat-toolbar color='primary'>Menu</mat-toolbar>\n    <mat-nav-list>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn()\" [routerLink]=\"['/profile']\" routerLinkActive=\"mat-accent\">Profile</a><br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn()\"  [routerLink]=\"['/order']\" routerLinkActive=\"mat-accent\">Order</a><br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn() && !this.userService.isUserAdmin()\"  [routerLink]=\"['/message']\" routerLinkActive=\"mat-accent\">Contact Admin</a> <br>\n      <a mat-button *ngIf=\"!userService.isUserLoggedIn()\" [routerLink]=\"['/signup']\" routerLinkActive=\"mat-accent\">Sign Up</a><br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn() && userService.isUserAdmin()\" [routerLink]=\"['/dashboard']\" routerLinkActive=\"mat-accent\" >Dashboard</a><br>\n      <a mat-button *ngIf=\"!userService.isUserLoggedIn()\"[routerLink]=\"['/signin']\" routerLinkActive=\"mat-accent\">Sign In</a> <br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn()\" (click)=\"signOut()\" >Sign Out</a>\n    </mat-nav-list>\n  </mat-sidenav\n >\n  <mat-sidenav-content>\n    <mat-toolbar color=\"primary\">\n      <button\n        type=\"button\"\n        aria-label=\"Toggle sidenav\"\n        mat-icon-button\n        (click)=\"drawer.toggle()\"\n        *ngIf=\"isHandset$ | async\">\n        <mat-icon aria-label=\"Side nav toggle icon\">menu</mat-icon>\n      </button>\n      <span>KassiOrder</span>\n    </mat-toolbar>\n    <ng-content #content></ng-content>\n\n  </mat-sidenav-content>\n</mat-sidenav-container>\n");
