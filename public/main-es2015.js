...
let DashboardComponent = class DashboardComponent {
    ...
    // accept order
    acceptOrder(id) {
        const data = { userid: sessionStorage.getItem('id'), orderid: id };
        this.orderService.acceptOrder(id, data).subscribe(acceptOrder => {
            this.viewAllOrders();
        });
    }
