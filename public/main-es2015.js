...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<mat-sidenav-container class=\"sidenav-container\">\n  <mat-sidenav\n              #drawer\n              class=\"sidenav\"\n              fixedInViewport=\"true\"\n              [attr.role]=\"(isHandset$ | async) ? 'dialog' : 'navigation'\"\n              [mode]=\"(isHandset$ | async) ? 'over' : 'side'\"\n              [opened]=\"(isHandset$ | async) === false\">\n    <mat-toolbar color='primary' (click)=\"drawer.opened = !drawer.opened\">Menu</mat-toolbar>\n    <mat-nav-list>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn()\" [routerLink]=\"['/profile']\" routerLinkActive=\"mat-accent\" (click)=\"drawer.opened = !drawer.opened\">Profile</a><br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn()\"  [routerLink]=\"['/order']\" routerLinkActive=\"mat-accent\" (click)=\"drawer.opened = !drawer.opened\">Order</a><br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn() && !this.userService.isUserAdmin()\"  [routerLink]=\"['/message']\" routerLinkActive=\"mat-accent\" (click)=\"drawer.opened = !drawer.opened\">Contact Admin</a> <br>\n      <a mat-button *ngIf=\"!userService.isUserLoggedIn()\" [routerLink]=\"['/signup']\" routerLinkActive=\"mat-accent\" (click)=\"drawer.opened = !drawer.opened\">Sign Up</a><br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn() && userService.isUserAdmin()\" [routerLink]=\"['/dashboard']\" routerLinkActive=\"mat-accent\" (click)=\"drawer.opened = !drawer.opened\">Dashboard</a><br>\n      <a mat-button *ngIf=\"!userService.isUserLoggedIn()\"[routerLink]=\"['/signin']\" routerLinkActive=\"mat-accent\" (click)=\"drawer.opened = !drawer.opened\">Sign In</a> <br>\n      <a mat-button *ngIf=\"userService.isUserLoggedIn()\" (click)=\"signOut()\" (click)=\"drawer.opened = !drawer.opened\">Sign Out</a>\n    </mat-nav-list>\n  </mat-sidenav\n >\n  <mat-sidenav-content >\n    <mat-toolbar color=\"primary\">\n      <button\n        type=\"button\"\n        aria-label=\"Toggle sidenav\"\n        mat-icon-button\n        (click)=\"drawer.toggle()\"\n        *ngIf=\"isHandset$ | async\">\n        <mat-icon aria-label=\"Side nav toggle icon\">menu</mat-icon>\n      </button>\n      <span (click)=\"drawer.opened = !drawer.opened\">KassiOrder</span>\n    </mat-toolbar>\n    <ng-content #content></ng-content>\n\n  </mat-sidenav-content>\n</mat-sidenav-container>\n");
...
let DashboardComponent = class DashboardComponent {
    ...
    filterText(filterText) {
        ...
        this.userService.getUsers2(this.paginator.pageSize, ++this.paginator.pageIndex, filterText).subscribe(data => {
            this.Users = data;
        }, err => {
            console.log(err);
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\n#phillip {\r\n  min-height: 100%;  /* Fallback for browsers do NOT support vh unit */\r\n  min-height: 100vh; /* These two lines are counted as one :-)       */\r\n\r\n  display: flex;\r\n  align-items: center;\r\n  background-image: url('brandless-18lr202tDKY-unsplash.jpg');\r\n  background-repeat: no-repeat;\r\n  background-position: center;\r\n\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* .container{\r\n  opacity: 0.9;\r\n} */\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".material-icons {\r\n  font-size: 50px;\r\n}\r\n\r\n#toplevel {\r\n  padding-bottom: 10%;\r\n}\r\n\r\n#toplevel{\r\n  opacity: 1;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("img {\r\n  height: 23rem;\r\n  margin: 3rem 1;\r\n  width: 350px;\r\n  border-radius: 50%;\r\n}\r\n/* .container{\r\n  opacity: 0.8;\r\n} */\r\nmat-form-field  {\r\n  width: 50%;\r\n}\r\n.container {\r\n  padding-bottom: 10%;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let UserService = class UserService {
    ...
    getUsers2(pageSize, currentPage, filter) {
        const query = `?pageSize=${pageSize}&currentPage=${currentPage}&filter=${filter}`;
        return this.httpClient.get('api/users' + query);
    }
    getUser(id) {
